...
def plot_decision_boundary(model: torch.nn.Module, X: torch.Tensor, y: torch.Tensor, color):
    ...
    plt.contourf(xx, yy, y_pred, cmap=color, alpha=0.25)
    plt.scatter(X[:, 0], X[:, 1], c=y, s=40, cmap=color)
